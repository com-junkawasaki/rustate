...
use crate::proto::{
    ...
    GetStateRequest, MachineState, BatchEventsRequest, BatchEventsResponse,
    UnregisterMachineRequest, UnregisterMachineResponse, WatchMachineRequest, EventDefinition,
    StateChangeEvent,
};
